...
tmux send -t robot_runtime:main.1 'export ENABLE_EKF=false;roslaunch me5413_world world.launch' ENTER
tmux send -t robot_runtime:main.2 'sleep 4' ENTER
tmux send -t robot_runtime:main.2 "export ENABLE_EKF=false;roslaunch final_slam localization_carto.launch" ENTER
